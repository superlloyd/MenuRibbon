...
TODO / Remark
- polish keyboard navigation more (remark: word doesn't do keyboard nav on the ribbon, just key tip)
- ItemsButton.IsSplit not working well
- focus keyboard navigation (on Ribbon Bar) going... somewhere...
